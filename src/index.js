...
var email_route_1 = require("./routes/email.route");
var notification_route_1 = require("./routes/notification.route");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                setInterval(telegram_controller_1.pollUpdates, 12000);
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
